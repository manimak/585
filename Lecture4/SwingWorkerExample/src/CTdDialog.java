...
class CTdDialog extends JInternalFrame {

    private static CTdDialog instance = null;
    ...
    public static CTdDialog getInstance() {
        if(instance == null) {
            instance = new CTdDialog();
        }
        return instance;
    }

    private void ctdActionPerformed() {
    ...
    private CTdDialog() {
        ...
        super("Cenrigal to decigal", false, true, false, false);
